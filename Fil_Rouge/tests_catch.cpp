...
TEST_CASE("Cercle", "[Cercle]") {
   ...
   REQUIRE(c1.toString() == "Cercle : coord (0,0,0,0)");
   REQUIRE(c2.toString() == "Cercle : coord (1,2,3,4)");

   c2.setRayon(10);
   REQUIRE(c2.getRayon()   == 10  );
   REQUIRE(c2.toString()   == "Cercle : coord (1,2,20,20)");
...
TEST_CASE("Polymorphisme", "[Forme]") {
   ...
   REQUIRE(f1->toString() == "Cercle : coord (0,0,0,0)");
   REQUIRE(f2->toString() == "Rectangle : coord (0,0,0,0)");
